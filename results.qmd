...
ggplot(
  wet_qual_data |> filter(!is.na(qual_for_comparison)),
  aes(y = fct_reorder(driver, qual_for_comparison, .fun = median),
  ...
  labs(title = "Intra-Team Wet-Weather Qualifying Pace",
